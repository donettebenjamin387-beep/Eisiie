task.spawn(function()  -- Wrap in thread to avoid yield issues
	local Players = game:GetService("Players")
	local TweenService = game:GetService("TweenService")
	local RunService = game:GetService("RunService")
	local UserInputService = game:GetService("UserInputService")
	local LocalPlayer = Players.LocalPlayer
	local PlayerGui = LocalPlayer:WaitForChild("PlayerGui")  -- Force wait for replication

	print("PlayerGui ready - Starting Flashlight Hub load...")  -- Debug
	...
	print("ScreenGui created & parented")  -- Debug
	...
	-- Start directly on AutoFarm (no landing)
	PageAuto.Visible = true
	print("AutoFarm page set visible")  -- Debug
	...
	notify("Flashlight Hub ready - Straight to AutoFarm • RightCtrl to toggle • Check F9")
	...
	print("Script fully loaded in thread - no errors expected")  -- Final debug
end)
